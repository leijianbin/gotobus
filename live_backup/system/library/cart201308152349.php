		...
		if (!$this->data) {
			foreach ($this->session->data['cart'] as $key => $quantity) {
				...
				if ($product_query->num_rows) {
					...
					$price = in_array(date("w",strtotime($departure_date)),explode("|",$product_query->row['special_date']))?$product_query->row['price_two']:$product_query->row['price'];
