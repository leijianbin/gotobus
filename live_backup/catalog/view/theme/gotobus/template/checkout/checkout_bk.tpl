...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="checkout">
    <div id="checkout" style="display：none">
      <div class="checkout-heading">Simple 3 steps to check Out</div>
    ...
    <div id="payment-address">
      ...
      <div class="checkout-content"><?php echo $text_checkout_payment_address; ?></div>
    </div>
    <?php } ?>
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				$.ajax({
					...
					dataType: 'html',
					success: function(html) {
						$('#confir .checkout-content').html(html);
						
						$('#payment-method .checkout-content').slideUp('slow');
						
						$('#confir .checkout-content').slideDown('slow');
