      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <!-- Edit the Departure categoty -->
            <tr>
              <td><?php echo $entry_depart_category; ?></td>
            ...
            <!--Add Arrival Place -->
            <tr>
              <td><?php echo $entry_arrival_category; ?></td>
              <td><input type="text" name="arrival_category" value="" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><div id="product-arrival-category" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($product_arrival_categories as $product_arrival_category) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-arrival-category<?php echo $product_arrival_category['category_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_arrival_category['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="product_arrival_category[]" value="<?php echo $product_arrival_category['category_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr> 
            ...
            <!-- Add departure/arrive time -->
            <tr>
            <td><?php echo $entry_departure_time; ?></td>
              <td><input type="text" name="departure_time" value="<?php echo $departure_time; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_arrive_time; ?></td>
              <td><input type="text" name="arrive_time" value="<?php echo $arrive_time; ?>" /></td>
            </tr>
            <!-- Add departure/arrive time -->

            <!-- Add departure/arrive station -->
            <tr>
            <td><?php echo $entry_departure_station; ?></td>
              <td><input size="100" type="text" name="departure_station" value="<?php echo $departure_station; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_arrive_station; ?></td>
              <td><input size="100" type="text" name="arrive_station" value="<?php echo $arrive_station; ?>" /></td>
            </tr>
            <!-- Add departure/arrive station -->
...
// Arrival Category
$('input[name=\'arrival_category\']').autocomplete({
  delay: 500,
  source: function(request, response) {
    $.ajax({
      url: 'index.php?route=catalog/category/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
  ...
  select: function(event, ui) {
    $('#product-arrival-category' + ui.item.value).remove();
    
    $('#product-arrival-category').append('<div id="product-arrival-category' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="product_arrival_category[]" value="' + ui.item.value + '" /></div>');

    $('#product-arrival-category div:odd').attr('class', 'odd');
    $('#product-arrival-category div:even').attr('class', 'even');
...
$('#product-arrival-category div img').live('click', function() {
  $(this).parent().remove();
