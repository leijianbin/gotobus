...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	protected function getForm() {
		...
		$this->data['entry_departure_time'] = $this->language->get('entry_departure_time');
		$this->data['entry_arrive_time'] = $this->language->get('entry_arrive_time');
		$this->data['entry_departure_station'] = $this->language->get('entry_departure_station');
		$this->data['entry_arrive_station'] = $this->language->get('entry_arrive_station');
    	...
    	$this->data['entry_depart_category'] = $this->language->get('entry_depart_category');
    	$this->data['entry_arrival_category'] = $this->language->get('entry_arrival_category');
    	...
    	// add departure_time and arrive_time 
    	if (isset($this->request->post['departure_time'])) {
      		$this->data['departure_time'] = $this->request->post['departure_time'];
    	} elseif (!empty($product_info)) {
			$this->data['departure_time'] = $product_info['departure_time'];
		} else {
      		$this->data['departure_time'] = '';
    	}

    	if (isset($this->request->post['arrive_time'])) {
      		$this->data['arrive_time'] = $this->request->post['arrive_time'];
    	} elseif (!empty($product_info)) {
			$this->data['arrive_time'] = $product_info['arrive_time'];
		} else {
      		$this->data['arrive_time'] = '';
    	}
		// add departure_time and arrive_time 
		
		// add departure_station and arrive_station 
    	if (isset($this->request->post['departure_station'])) {
      		$this->data['departure_station'] = $this->request->post['departure_station'];
    	} elseif (!empty($product_info)) {
			$this->data['departure_station'] = $product_info['departure_station'];
		} else {
      		$this->data['departure_station'] = '';
    	}

    	if (isset($this->request->post['arrive_station'])) {
      		$this->data['arrive_station'] = $this->request->post['arrive_station'];
    	} elseif (!empty($product_info)) {
			$this->data['arrive_station'] = $product_info['arrive_station'];
		} else {
      		$this->data['arrive_station'] = '';
    	}
		// add departure_station and arrive_station 
		...
		// Arrival Categories -------------------
		if (isset($this->request->post['product_arrival_category'])) {
			$categories = $this->request->post['product_arrival_category'];
		} elseif (isset($this->request->get['product_id'])) {		
			$categories = $this->model_catalog_product->getProductArrivalCategories($this->request->get['product_id']);
		} else {
			$categories = array();
		}

		$this->data['product_arrival_categories'] = array();
		
		foreach ($categories as $category_arrival_id) {
			$category_info = $this->model_catalog_category->getCategory($category_arrival_id);
