    	...
    	*/
		...
		if ($order_info) {
			...
			*/
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/order_info1.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/account/order_info1.tpl';
			} else {
				$this->template = 'default/template/account/order_info1.tpl';
			}
