...
<div class="wholesearchbar">
  <div class="tickettitle">Bus Tickets</div>
  <div class="box-content">
    <div class="searchbar">
      ...
      <div id="dropdown-categories" style="padding: 7px 0px;">
        ...
        <div class="flight" style="border-bottom-color: #B5B5B5; border-bottom-style:dashed; border-bottom-width:1px; padding-bottom: 8px; ">
          <ol>
            ...
            <li class="radio">
              <input type="radio" name="search" id="one-way" value="one-way"/>
      ...
      <div class="searchTool searchtoolfloat">
...
<div class="pickdate" style=" border-bottom-color: #B5B5B5; border-bottom-style:dashed; border-bottom-width:1px; height: 64px; padding-top:1px; ">
  ...
  <div class="subdep1 searchtoolfloat" id="date-return-div">
    <div>
...
$('.searchbar input[name=\'search\']').keydown(function(e) {
  if (e.keyCode == 13) {
...
$('#button-search').bind('click', function() {
  ...
  var search = $('.searchbar input[name=\'search\']:checked').attr('value');
  ...
  var filter_date = $('.searchbar input[name=\'filter_date\']').attr('value');
  ...
  var filter_return_date = $('.searchbar input[name=\'filter_return_date\']').attr('value');
